...
docs/                  Quarto book — the site source
  ...
  images/                  figures generated by scripts/figures/
  theme.scss               site theme (shared visual language with sibling repos)
scripts/figures/        one small standalone script per diagram — computed
                          layouts (a DAG layering, not hand-placed boxes),
                          rendered to static PNGs in docs/images/
