...
## Six threads that keep coming back
...
- **Approximation** — a [limit](17-limits-and-continuity.qmd) is already an
  infinite sequence of approximations agreed to converge; [Taylor
  approximation](18-differentiation.qmd) builds successively better
  polynomial stand-ins for a function; Euler's method approximates a
  [differential equation](20-differential-equations.qmd)'s solution one
  small step at a time; [gradient descent](23-optimization.qmd) approximates
  a function's minimum the same way, and [training a
  model](24-machine-learning.qmd) is that same process at scale. Underneath
  most of this site's later, more computational chapters is some version of
  "replace an exact but intractable answer with a sequence of tractable ones
  that provably get close enough."
