...
![Roughly when each idea first appeared, wrapped into two rows so eight entries stay readable at page width. Dates are approximate throughout — see the caveats above and in `appendix-references.qmd`.](../images/historical-timeline.png){#fig-historical-timeline}
